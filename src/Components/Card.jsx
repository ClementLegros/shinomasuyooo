    ...
    <div className="pt-5 md:px-5 w-full">
      <div className="w-full">
        <div className="flex flex-row justify-center">
          {islr ? (
            <button
              className="w-16 rounded-md mr-2 bg-slate-200 dark:bg-zinc-700 dark:text-white"
              onClick={() => passageLr()}
            >
              LR
            </button>
          ...
          <button
            className="w-16 rounded-md bg-slate-200 dark:bg-zinc-700 dark:text-white"
            onClick={() => passageUr()}
          >
            UR
          </button>
          <button
            className="ml-2 w-16 rounded-md bg-slate-200 dark:bg-zinc-700 dark:text-white"
            onClick={() => passageSsr()}
          >
            SSR
          </button>
        ...
        <div className="flex flex-col justify-center items-center">
          <Link to={"/card/" + card.id}>
            {lr ? (
              <img
                className="cursor-pointer h-56 md:h-80"
                alt="lrcardimg"
                src={card.lrcardimg}
              />
            ) : ur ? (
